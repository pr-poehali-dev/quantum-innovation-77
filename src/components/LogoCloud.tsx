...
import { Shield, Building2, Car, Heart, Home, Plane, Briefcase, Umbrella } from "lucide-react"

const companies = [
  { name: "Ингосстрах", icon: Shield },
  { name: "Росгосстрах", icon: Building2 },
  { name: "РЕСО", icon: Car },
  { name: "АльфаСтрах", icon: Heart },
  { name: "Согаз", icon: Home },
  { name: "ВТБ Страхование", icon: Plane },
  { name: "Тинькофф", icon: Briefcase },
  { name: "Сбербанк СЖ", icon: Umbrella },
]
    ...
    <div className="relative z-20 pb-24 pt-8" style={{ backgroundColor: "#09090B" }}>
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-4xl text-center">
          ...
          >
            Доверие ведущих страховых компаний России.
          </motion.p>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            От региональных игроков до федеральных страховщиков.
          </motion.p>
